...
const EditAppoitmentType = ({route}: any) => {
  const item = route.params?.name;
  const id = route.params?.id;
  const fromAppointment = route.params?.fromAppointment;
  ...
  return (
    <View flex={1} bg={'white'}>
      <Header title={'Edit Appointment Type'} />
...
export default EditAppoitmentType;
